# 🏗️ Schéma Global de l'Infrastructure AgoraFlux
...
### 🌍 **Production**
- **Frontend** : Netlify/Vercel (JAMstack)
...
- **Logs** : Loguru + rotation automatique
- **Metrics** : CPU, RAM, requêtes/sec
- **Alerts** : Surveillance proactive
...
*Cette infrastructure supporte actuellement **79 tests backend** et **5 tests frontend** avec un taux de réussite de **100%** sur l'ensemble de la stack.* 